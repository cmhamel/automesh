...
fn test_finite_elements(
    ...
    nodal_influencers_gold: Connectivity,
) {
...
fn cube_with_inclusion() {
    ...
    let element_node_connectivity = vec![
        vec![1, 2, 6, 5, 17, 18, 22, 21],
        vec![2, 3, 7, 6, 18, 19, 23, 22],
        vec![3, 4, 8, 7, 19, 20, 24, 23],
        vec![5, 6, 10, 9, 21, 22, 26, 25],
        vec![6, 7, 11, 10, 22, 23, 27, 26],
        vec![7, 8, 12, 11, 23, 24, 28, 27],
        vec![9, 10, 14, 13, 25, 26, 30, 29],
        vec![10, 11, 15, 14, 26, 27, 31, 30],
        vec![11, 12, 16, 15, 27, 28, 32, 31],
        vec![17, 18, 22, 21, 33, 34, 38, 37],
        vec![18, 19, 23, 22, 34, 35, 39, 38],
        vec![19, 20, 24, 23, 35, 36, 40, 39],
        vec![21, 22, 26, 25, 37, 38, 42, 41],
        vec![22, 23, 27, 26, 38, 39, 43, 42],
        vec![23, 24, 28, 27, 39, 40, 44, 43],
        vec![25, 26, 30, 29, 41, 42, 46, 45],
        vec![26, 27, 31, 30, 42, 43, 47, 46],
        vec![27, 28, 32, 31, 43, 44, 48, 47],
        vec![33, 34, 38, 37, 49, 50, 54, 53],
        vec![34, 35, 39, 38, 50, 51, 55, 54],
        vec![35, 36, 40, 39, 51, 52, 56, 55],
        vec![37, 38, 42, 41, 53, 54, 58, 57],
        vec![38, 39, 43, 42, 54, 55, 59, 58],
        vec![39, 40, 44, 43, 55, 56, 60, 59],
        vec![41, 42, 46, 45, 57, 58, 62, 61],
        vec![42, 43, 47, 46, 58, 59, 63, 62],
        vec![43, 44, 48, 47, 59, 60, 64, 63],
    ];
    let nodal_coordinates = vec![
        vec![0.0, 0.0, 0.0],
        vec![1.0, 0.0, 0.0],
...
fn bracket() {
    ...
    let element_node_connectivity = vec![
        vec![1, 2, 7, 6, 22, 23, 28, 27],
        vec![2, 3, 8, 7, 23, 24, 29, 28],
        vec![3, 4, 9, 8, 24, 25, 30, 29],
        vec![4, 5, 10, 9, 25, 26, 31, 30],
        vec![6, 7, 12, 11, 27, 28, 33, 32],
        vec![7, 8, 13, 12, 28, 29, 34, 33],
        vec![8, 9, 14, 13, 29, 30, 35, 34],
        vec![9, 10, 15, 14, 30, 31, 36, 35],
        vec![11, 12, 17, 16, 32, 33, 38, 37],
        vec![12, 13, 18, 17, 33, 34, 39, 38],
        vec![16, 17, 20, 19, 37, 38, 41, 40],
        vec![17, 18, 21, 20, 38, 39, 42, 41],
    ];
    let nodal_coordinates = vec![
        vec![0.0, 0.0, 0.0],
        vec![1.0, 0.0, 0.0],
    ...
    let laplacian_gold = vec![
        ...
        vec![ZERO, ONE_FOURTH, ONE_FOURTH],
        vec![-ONE_THIRD, ONE_THIRD, ONE_THIRD],
        vec![ONE_FOURTH, ZERO, ONE_FOURTH],
        vec![ZERO, ZERO, ONE_FIFTH],
        vec![ZERO, ZERO, ONE_FIFTH],
        vec![ZERO, ZERO, ONE_FIFTH],
        vec![-ONE_FOURTH, ZERO, ONE_FOURTH],
        vec![ONE_FOURTH, ZERO, ONE_FOURTH],
    ...
    let smoothed_coordinates_gold = vec![
        ...
        vec![
            vec![0.1875, 0.1875, 0.175],
            vec![1.0075, 0.14625, 0.1395],
            vec![2.0, 0.144375, 0.137625],
            vec![2.9925, 0.14625, 0.1395],
            vec![3.8125, 0.1875, 0.175],
            vec![0.14625, 1.0075, 0.1395],
            vec![1.0045, 1.0045, 0.1146],
            vec![2.0, 1.0045, 0.1137],
            vec![2.9955, 1.0, 0.1155],
            vec![3.851875, 1.0, 0.141375],
            vec![0.144375, 2.0, 0.137625],
            vec![1.0045, 2.0, 0.1137],
            vec![1.9955, 1.9955, 0.1146],
            vec![2.9925, 1.859375, 0.138375],
            vec![3.8125, 1.8125, 0.175],
            vec![0.14625, 2.9925, 0.1395],
            vec![1.0, 2.9955, 0.1155],
            vec![1.859375, 2.9925, 0.138375],
            vec![0.1875, 3.8125, 0.175],
            vec![1.0, 3.851875, 0.141375],
            vec![1.8125, 3.8125, 0.175],
            vec![0.1875, 0.1875, 0.8250],
            vec![1.0075, 0.14625, 0.8605],
            vec![2.0, 0.144375, 0.862375],
            vec![2.9925, 0.14625, 0.8605],
            vec![3.8125, 0.1875, 0.8250],
            vec![0.14625, 1.0075, 0.8605],
            vec![1.0045, 1.0045, 0.8854],
            vec![2.0, 1.0045, 0.8863],
            vec![2.9955, 1.0, 0.8845],
            vec![3.851875, 1.0, 0.858625],
            vec![0.144375, 2.0, 0.862375],
            vec![1.0045, 2.0, 0.8863],
            vec![1.9955, 1.9955, 0.8854],
            vec![2.9925, 1.859375, 0.861625],
            vec![3.8125, 1.8125, 0.8250],
            vec![0.14625, 2.9925, 0.8605],
            vec![1.0, 2.9955, 0.8845],
            vec![1.859375, 2.9925, 0.861625],
            vec![0.1875, 3.8125, 0.8250],
            vec![1.0, 3.851875, 0.858625],
            vec![1.8125, 3.8125, 0.8250],
        ],
    ];
    test_finite_elements(
        element_blocks,
