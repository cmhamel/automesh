...
fn filter_voxel_data(
    ...
    let ignored_data = ignore.unwrap_or(&[0]);
            ...
            data_k
                ...
                .map(|(j, data_kj)| {
                    data_kj
                        .iter()
                        .enumerate()
                        .filter(|(_, &data_kji)| !ignored_data.contains(&data_kji))
...
fn finite_element_data_from_npy_data(
    ...
    let (filtered_voxel_data, element_blocks) = filter_voxel_data(data, ignore);
